...
/// <summary>
/// Reserved for future model-specific video-input mapping.
...
public class VideoInputEnum : Enumeration<VideoInputEnum>
{
    ...
    public static readonly VideoInputEnum Usbc1 = new(11, "Usbc1");
    public static readonly VideoInputEnum Usbc2 = new(12, "Usbc2");
}
